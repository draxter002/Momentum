        ...
        <div className="flex items-center justify-between gap-6">
          ...
          <div className="flex-1 max-w-xl">
            <div className="flex items-center space-x-4">
              <span className="text-base font-semibold text-gray-700 whitespace-nowrap min-w-fit">
              ...
              {badgeEmoji && (
                <span className="text-3xl drop-shadow-lg animate-bounce" title={todaySummary?.badgeTier}>
                  {badgeEmoji}
                </span>
              )}
            </div>
          ...
          <div className="flex items-center gap-4 min-w-fit">
            {/* Current Time */}
            <div className="flex items-center gap-1.5 px-2.5 py-2.5 rounded-xl border-2 border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 shadow-md min-w-[100px]">
              <span className="text-lg">🕐</span>
              <div className="flex flex-col">
                <span className="text-[9px] font-medium uppercase tracking-wide text-blue-700">Now</span>
            ...
            {/* Gold Streak */}
            <div className={`flex items-center gap-3 px-5 py-3 rounded-xl border-2 shadow-lg hover:shadow-xl transition-all hover:scale-105 ${
            ...
            <button 
              ...
              className="w-14 h-14 bg-gradient-to-br from-blue-600 to-indigo-700 text-white rounded-full flex items-center justify-center hover:from-blue-700 hover:to-indigo-800 transition-all shadow-lg hover:shadow-xl hover:scale-110 transform"
              title="Profile"
            >
